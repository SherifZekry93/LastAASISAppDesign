...
import UIKit
class PermissionVC:UIViewController,UITextViewDelegate
{
    ...
    override func viewDidLoad() {
        ...
        setupTitleView(title: "Permssion", comparedTo:nil ,adjust: false)
    ...
    fileprivate func addSubmitButton()
    {
        ...
        //view.insertSubview(submitButton, belowSubview: nil)
    ...
    fileprivate func addDatePicker() {
        ...
        datePicker.anchorToView(top: submitButton.bottomAnchor, leading: nil, bottom: nil, trailing: nil, padding: .init(top: 10, left: 0, bottom: 0, right: 0), centerH: true)// centerV: <#T##Bool?#>)
        datePicker.isHidden = true
    }
    
    fileprivate func setupTextFieldView()
    {
        addSubview(remarksTextView)
        //view.insertSubview(remarksTextView, belowSubview: nil)
    ...
    fileprivate func setupPermissionVCViews()
    {
        ...
        backButton.anchorToView(top: view.safeAreaLayoutGuide.topAnchor, leading: view.leadingAnchor, bottom: nil, trailing: nil, padding: .init(top: 15, left: 21, bottom: 0, right: 0), size: .init(width: 20, height: 20))
    ...
    @objc func datePickerChanged(sender:UIDatePicker) {
        ...
        selectFromDateView = getASelectionView(image: #imageLiteral(resourceName: "menuCalendar"), text: dateString)
    }
